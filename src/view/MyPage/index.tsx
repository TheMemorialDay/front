...
import './style.css';
import { MY_INFO_PATH, MY_REVIEW_PATH, MY_ORDER_DETAIL_PATH, MY_LIKE_PATH, MY_STORE_PATH, MY_PRODUCT_PATH, MY_ORDER_MANAGE_PATH, MY_SALES_PATH } from '../../constants';
...
const MyPage = () => {
    ...
    return (
        <div id='myPage'>
            ...
            <div id='general'>
                <div className='userInfo' onClick={() => onClickNavigation(MY_INFO_PATH)}>
            ...
            <div id='ceo'>
                <div className='userInfo' onClick={() => onClickNavigation(MY_STORE_PATH)}>
                    <div className='category-icon'></div>
                ...
                <div className='order-detail' onClick={() => onClickNavigation(MY_ORDER_MANAGE_PATH)}>
                    <div className='order-manage-icon'></div>
                    <div className='category-title'>주문 관리</div>
                </div>
                <div className='like' onClick={() => onClickNavigation(MY_SALES_PATH)}>
                    <div className='category-icon'></div>
